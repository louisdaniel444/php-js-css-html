...
<body>
  ...
  <main class="d-flex flex-col ">
    <h1 class="p-2 pt-2 pb-0 w-fit mx-auto">À propos de moi </h1>

    <!--Qui suis-je ?-->
    <section class="qui-suis-je">
      <div class="d-flex flex-col items-center  p-2 gap-2">
        <h2>Qui suis-je ?</h2>
        ...
        <div class="d-flex flex-row flex-wrap gap-2 items-center justify-between mw-50">
          ...
          <img class="img-about w-full" src="https://img.freepik.com/vecteurs-libre/homme-pensant-portrait-illustration-isolee_24911-115060.jpg" />
        </div>
        ...
        <a class="btn" href="<?= htmlspecialchars($host . '/contact'); ?>">Contactez-moi</a>
      </div>
    </section>
  </main>
